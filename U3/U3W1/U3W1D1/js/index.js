...
class User {
  ...
  ricarica(importo) {
    ...
    console.log(
      `${this.nome} ${this.cognome} ha ricaricato di ${importo} euro. Credito attuale: ${this.credito} euro.`
    );
  }
  chiamata(minuti) {
    ...
    if (this.credito >= costoChiamata) {
      ...
      console.log(
        `${this.nome} ${this.cognome} ha effettuato una chiamata di ${minuti} minuti. Costo: ${costoChiamata} euro. Credito residuo: ${this.credito} euro.`
      );
    } else {
      console.log(
        `Credito insufficiente per effettuare la chiamata di ${minuti} minuti.`
      );
    }
  }
  chiama404() {
  ...
  azzeraChiamate() {
    this.numeroChiamate = 0;
    console.log(
      `Il contatore delle chiamate di ${this.nome} ${this.cognome} è stato azzerato.`
    );
  }
}
// Esempio di utilizzo
...
console.log(
  `Numero di minuti di chiamata dopo azzeramento: ${userM.getNumeroChiamata()}`
...
console.log(
  `Numero di minuti di chiamata dopo azzeramento: ${userL.getNumeroChiamata()}`
);
console.log("D");
